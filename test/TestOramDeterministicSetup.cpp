...
TEST_CASE("Test deterministic ORAM setup very small numBlocks")
{	
	int bucketSize = 2;
	int numBlocks = 1;
...
TEST_CASE("Test deterministic ORAM setup small numBlocks")
{	
	int bucketSize = 2;
	int numBlocks = 32;
	Bucket::setMaxSize(bucketSize);	
...
TEST_CASE("Test deterministic ORAM setup larger numBlocks")
{	
	int bucketSize = 2;
	int numBlocks = 1024;
	Bucket::setMaxSize(bucketSize);	
...
TEST_CASE("Test deterministic ORAM setup very large numBlocks")
{	
	int bucketSize = 2;
...
TEST_CASE("Test deterministic ORAM setup numBlocks not power of 2")
{	
	int bucketSize = 2;
	int numBlocks = 30;
	Bucket::setMaxSize(bucketSize);	
